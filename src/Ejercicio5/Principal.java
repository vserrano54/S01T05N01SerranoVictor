...
public class Principal {
	...
	public static void main(String args[]) {
		...
		directorio.escribirArchivoSerializado(nombreDirectorio + "/ArchivoSerializado.ser", directorio.getDatosParaGuardar());
		
		System.out.println("Archivo recuperado");
		
		directorio.leerArchivoSerializado(nombreDirectorio + "/ArchivoSerializado.ser");
